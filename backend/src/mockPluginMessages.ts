...
/**
 * Mock plugin messages simulating EuroScope data for ESGG (Gothenburg)
 * These messages will be processed by the flight store to create flights and strips
 */
...
/**
 * Mock messages to simulate initial flight data at ESGG
 *
 * Layout:
...
export const mockPluginMessages: PluginMessage[] = [
    ...
    // Note: clearedToLand and airborne flags are set by backend, not plugin messages
    // For mock data, we'll add these after processing via direct flight store manipulation
    ...
    fpUpdate('BRA841', 'ESGG', 'ESSB', 'A319', {
        rfl: 12000,
        depRwy: '21',
        sid: 'OSNAK1D',
        route: 'DCT'
