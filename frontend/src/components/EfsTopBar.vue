<template>
  <v-app-bar color="#2b2d31" height="25" elevation="0" class="text-body-2 text-grey">
    <!-- Top bar placeholder -->
    <v-btn variant="text" size="small" color="grey">ESXX_TWR</v-btn>
    <v-spacer />
    <v-btn v-if="!fullscreen" variant="text" icon="mdi-fullscreen" class="text-grey" @click="requestFullScreen"></v-btn>
